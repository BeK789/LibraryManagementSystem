 ...
 <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>"  method="post" enctype="multipart/form-data" >
			...
			<div class="row form-group">
		    		<div class="col-sm-2"><label for="name"><strong>Stock</strong></label></div>
					
		    		<div class="col-sm-7"> 
					<input class="form-control form-group" type="text" name="stock" id="name" value="<?php echo $row['stock'];?>" placeholder="Enter Name"  /> 
